  ...
  * ================================ */
  ...
  , template: function() {
      if (this.options.bsVersion == '2') {
        return '<div class="combobox-container"><input type="hidden" /> <div class=""> <input type="text" autocomplete="off" onChange="alert(this.val())" /> <span class="add-on dropdown-toggle" data-dropdown="dropdown"> </div>'
      } else if (this.options.bsVersion == '3') {
        return '<div class="combobox-container"> <input type="hidden" /> <div class=""> <input type="text" autocomplete="off" /> <span class="input-group-addon dropdown-toggle" data-dropdown="dropdown"> <span class="caret pulldown" /> </div> </div>'
      } else {
        return '<div class="combobox-container"> <input type="hidden" /> <div class=""> <input type="text" autocomplete="off" onChange="console.log(this.value)" />'
  ...
  , change: function (event){
	  console.log(event);
	  this.$target.val(event.target.value)
  }
  , move: function (e) {
