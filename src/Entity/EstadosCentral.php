...
/**
 * @ORM\Entity(repositoryClass="App\Repository\EstadosCentralRepository")
 */
class EstadosCentral
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Materiales", mappedBy="estado_central")
     */
    private $materiales;
    ...
    public function addMateriale(Materiales $materiale): self
    {
        if (!$this->materiales->contains($materiale)) {
            ...
            $materiale->setEstadoCentral($this);
        }
    ...
    public function removeMateriale(Materiales $materiale): self
    {
        if ($this->materiales->contains($materiale)) {
            ...
            if ($materiale->getEstadoCentral() === $this) {
                $materiale->setEstadoCentral(null);
            }
        }
